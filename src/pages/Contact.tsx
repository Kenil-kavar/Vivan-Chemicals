...
const Contact = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      const response = await fetch(`${import.meta.env.VITE_API_URL || 'http://localhost:8001'}/api/contact-us`, {
        method: 'POST',
        headers: {
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              >
                <div className="h-full min-h-[500px] bg-card rounded-2xl border border-border overflow-hidden shadow-xl">
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4968.23067871636!2d70.92175188844787!3d22.837628258171783!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39598f005af73f1d%3A0xa6d694e3931a29c5!2sVivan%20Chemical!5e1!3m2!1sen!2sin!4v1764341472350!5m2!1sen!2sin"
                    width="100%"
                    height="100%"
                    style={{ border: 0 }}
                    allowFullScreen
